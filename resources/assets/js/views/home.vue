        ...
        <div v-else>
            <div>
                ...
                <md-dialog :md-active.sync="detailDialog">
                    <detail :req_id="req_id" :stat_id="stat_id" lb="Detail" @refresh="getData()"
            ...
            <paginate ref="paginator" name="tiket_page" :list="tiket_filter" tag="div" :per="5">
                <md-table v-model="tiket_" md-sort="name" md-sort-order="asc" md-card>
                    ...
                    <md-table-row slot="md-table-row" slot-scope="{item}">
                        <md-table-cell md-label="Pengirim" md-sort-by="diajukan_oleh">{{ item.diajukan_oleh }}
                        </md-table-cell>
                        <md-table-cell md-label="Isi" md-sort-by="deskripsi_masalah">{{ item.deskripsi_masalah | isi }}
                        </md-table-cell>
                        ...
                        <md-table-cell md-label="Kategori" md-sort-by="kategori_nama">{{ item.kategori_nama }}
                        </md-table-cell>
                        <md-table-cell md-label="Prioritas" md-sort-by="prioritas_nama">{{ item.prioritas_nama }}
                        </md-table-cell>
                        ...
                        <md-table-cell class="" md-label="Aksi" md-sort-by="">
                            ...
                            <md-button :disabled="tidakaktif(item.stat_id)" class="md-icon-button md-accent"
                                v-on:click="sudahtiket(item.req_id, item.stat_id)">
            ...
            <div class="md-layout md-gutter">
                ...
                <div class="md-layout-item md-toolbar-section-end">
                    <paginate-links for="tiket_page" tag="div" :async="true" :show-step-links="true" :step-links="{
                            next: '>',
                            prev: 'chevron_left'
                        }" :limit="2" :hide-single-page="true" :classes="{
